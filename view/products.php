...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark p-0 m-0" style="display: block">
    <!-- Navbar text-->
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <form action="addbasket.php" method="post" class="product">
                            ...
                            <button class="btn btn-primary text-center addToBasketBtn" role="button"><?php $product->getProductId; ?>
